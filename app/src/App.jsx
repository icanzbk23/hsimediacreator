...
const INITIAL_VENUES = [
  { id:1,  name:"Mikado Restaurant",   concept:"", stock:2,  color:"#E8503A", phone:"", instagram:"", introVideos:[], referenceLinks:[], venueAnalysis:"", instagramData:null, ideas:[] },
  { id:2,  name:"Harvey Burger",       concept:"", stock:1,  color:"#7B68EE", phone:"", instagram:"", introVideos:[], referenceLinks:[], venueAnalysis:"", instagramData:null, ideas:[] },
  { id:3,  name:"Sinan Özdemir", concept:"", stock:0, color:"#34C759", phone:"", instagram:"", introVideos:[], referenceLinks:[], venueAnalysis:"", instagramData:null, ideas:[] },
  { id:5,  name:"Sultan Sofrası",      concept:"Hatay yöresel yemekler", stock:2, color:"#C0392B", phone:"", instagram:"", introVideos:[], referenceLinks:[], venueAnalysis:"", instagramData:null, ideas:[] },
  { id:6,  name:"Ege Döner",           concept:"", stock:0,  color:"#48BFAB", phone:"", instagram:"", introVideos:[], referenceLinks:[], venueAnalysis:"", instagramData:null, ideas:[] },
  { id:7,  name:"Kuban Kuruyemiş",     concept:"", stock:0,  color:"#E8A0BF", phone:"", instagram:"", introVideos:[], referenceLinks:[], venueAnalysis:"", instagramData:null, ideas:[] },
  { id:8,  name:"Şenöz",                concept:"", stock:1,  color:"#D4871E", phone:"", instagram:"", introVideos:[], referenceLinks:[], venueAnalysis:"", instagramData:null, ideas:[] },
  { id:9,  name:"YSANTOCHİA",      concept:"", stock:1,  color:"#9B7FBA", phone:"", instagram:"", introVideos:[], referenceLinks:[], venueAnalysis:"", instagramData:null, ideas:[] },
  { id:10, name:"Sütlü Kavurma",       concept:"", stock:19,  color:"#2C3E6B", phone:"", instagram:"", introVideos:[], referenceLinks:[], venueAnalysis:"", instagramData:null, ideas:[] },
  { id:11, name:"Süleyman Usta Döner", concept:"", stock:8,  color:"#8B4513", phone:"", instagram:"", introVideos:[], referenceLinks:[], venueAnalysis:"", instagramData:null, ideas:[] },
  { id:12, name:"İSTE Çiftlik",        concept:"Hatay yöresel ürünler", stock:0, color:"#5C7A4E", phone:"", instagram:"", introVideos:[], referenceLinks:[], venueAnalysis:"", instagramData:null, ideas:[] },
  { id:13, name:"Sezai Usta",          concept:"Kebap mangal", stock:1, color:"#E67E22", phone:"", instagram:"", introVideos:[], referenceLinks:[], venueAnalysis:"", instagramData:null, ideas:[] },
  { id:14, name:"Musta Döner",         concept:"", stock:2,  color:"#4A7C8E", phone:"", instagram:"", introVideos:[], referenceLinks:[], venueAnalysis:"", instagramData:null, ideas:[] },
  { id:15, name:"Saudade",             concept:"", stock:5,  color:"#8B1A2F", phone:"", instagram:"", introVideos:[], referenceLinks:[], venueAnalysis:"", instagramData:null, ideas:[] },
  { id:16, name:"Ege Büfe",            concept:"", stock:1,  color:"#00CED1", phone:"", instagram:"", introVideos:[], referenceLinks:[], venueAnalysis:"", instagramData:null, ideas:[] },
  { id:17, name:"Bugga",               concept:"", stock:8,  color:"#FF6B35", phone:"", instagram:"", introVideos:[], referenceLinks:[], venueAnalysis:"", instagramData:null, ideas:[] },
  { id:18, name:"Helvacı Ali",         concept:"", stock:4,  color:"#A0522D", phone:"", instagram:"", introVideos:[], referenceLinks:[], venueAnalysis:"", instagramData:null, ideas:[] },
  { id:19, name:"Kanatçı Resul",      concept:"", stock:2,  color:"#6B8E23", phone:"", instagram:"", introVideos:[], referenceLinks:[], venueAnalysis:"", instagramData:null, ideas:[] },
];
